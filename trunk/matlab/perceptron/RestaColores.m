function color = RestaColores(mat1,mat2,color,tol)
    ...
    for j=1:szMat2        
        % deja colores de fondo oculto de la imagen como parte de
        % colores a discriminar  2009-08-22 00:24
        R = mat2(j,1);
        G = mat2(j,2);
        B = mat2(j,3);
        H = mat2(j,4);
    ...
    for i=1:szMat1
        ...
        for j=n:szMat2
            ...
            if(index1 == index2)
                % colores comunes a ambas imagenes son colores de fondo,
                % por tanto son colores a descartar en segmentacion
                R = mat1(i,1);
                G = mat1(i,2);
                B = mat1(i,3);
                H = mat1(i,4);
    ...
    for i=1:szMat1
        ...
        if(index > 0)
            % los colores restantes difieren de ambas imagenes en comun
            % por tanto es un color para segmentar
            R = mat1(i,1);
            G = mat1(i,2);
            B = mat1(i,3);
            H = mat1(i,4);
